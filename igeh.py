...
class MAIN:
   ...
   def __init__(self):
       super(MAIN).__init__()
       self.head = {'user-agent': 'Dalvik/2.1.0 (Linux; U; Android 14; SM-A137F Build/UP1A.231005.007) 38.0.0.13.95 Android (26/8.0.0; 320dpi; 720x1184; Sony; F5321; F5321; qcom; ru_RU; 99640905)',}
...
[white]Masukan Nama File Untuk Melihat Hasil, Gunakan koma untuk pemisahan nama file',True)
   ...
   def Exekusi(self, uid, cokie, next, mode,unli=None):
       global xx
       headers = {'Host': 'www.instagram.com','x-requested-with': 'XMLHttpRequest','x-csrftoken': re.search('csrftoken=(.*?);',str(cokie['cookie'])).group(1),'x-ig-app-id': '1217981644879628','user-agent': 'Dalvik/2.1.0 (Linux; U; Android 13; Infinix X6832 Build/TP1A.220624.014)','accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7',}
   ...
   def Graphql(self, typess, userid, cokie,after):
       ...
       try:
           self.ptk = {"user-agent": "Dalvik/2.1.0 (Linux; U; Android 13; Realme 5 Pro Build/TQ3A.230705.001)","accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","cookie": cokie}
 ...
 {P}data profile : {K2}{followers}/{following}/{postingan}                             ''')
   ...
   def headers_graph(self, xxx):
       headers = {
           ...
           'user-agent': 'Dalvik/2.1.0 (Linux; U; Android 14; SM-A135F Build/UP1A.231005.007)',
